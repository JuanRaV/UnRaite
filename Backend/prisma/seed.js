...
async function main() {
  ...
  await prisma.townToGdl.upsert({ where: { id: 1 }, update:{}, create:{ townName: "Acatic", price: 145 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 4 }, update:{}, create:{ townName: "Amacueca", price: 223 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 8 }, update:{}, create:{ townName: "Arandas", price: 304 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 13 }, update:{}, create:{ townName: "Atotonilco el Alto", price: 228 } })
  await prisma.townToGdl.upsert({ where: { id: 14 }, update:{}, create:{ townName: "Atoyac", price: 205 } })
  await prisma.townToGdl.upsert({ where: { id: 15 }, update:{}, create:{ townName: "Autlán de Navarro", price: 437 } })
  await prisma.townToGdl.upsert({ where: { id: 16 }, update:{}, create:{ townName: "Ayotlán", price: 285 } })
  await prisma.townToGdl.upsert({ where: { id: 17 }, update:{}, create:{ townName: "Ayutla", price: 354 } })
  await prisma.townToGdl.upsert({ where: { id: 18 }, update:{}, create:{ townName: "La Barca", price: 244 } })
  await prisma.townToGdl.upsert({ where: { id: 19 }, update:{}, create:{ townName: "Bolaños", price: 510 } })
  await prisma.townToGdl.upsert({ where: { id: 20 }, update:{}, create:{ townName: "Cabo Corrientes", price: 793 } })
  await prisma.townToGdl.upsert({ where: { id: 21 }, update:{}, create:{ townName: "Casimiro Castillo", price: 527 } })
  await prisma.townToGdl.upsert({ where: { id: 22 }, update:{}, create:{ townName: "Cihuatlán", price: 750 } })
  await prisma.townToGdl.upsert({ where: { id: 23 }, update:{}, create:{ townName: "Zapotlán el Grande", price: 304 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 33 }, update:{}, create:{ townName: "Degollado", price: 375 } })
  await prisma.townToGdl.upsert({ where: { id: 34 }, update:{}, create:{ townName: "Ejutla", price: 400 } })
  await prisma.townToGdl.upsert({ where: { id: 35 }, update:{}, create:{ townName: "Encarnación de Díaz", price: 420 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 41 }, update:{}, create:{ townName: "Huejuquilla el Alto", price: 835 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 45 }, update:{}, create:{ townName: "Jalostotitlán", price: 297 } })
  await prisma.townToGdl.upsert({ where: { id: 46 }, update:{}, create:{ townName: "Jamay", price: 228 } })
  await prisma.townToGdl.upsert({ where: { id: 47 }, update:{}, create:{ townName: "Jesús María", price: 552 } })
  await prisma.townToGdl.upsert({ where: { id: 48 }, update:{}, create:{ townName: "Jilotlán de los Dolores", price: 520 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 52 }, update:{}, create:{ townName: "Lagos de Moreno", price: 430 } })
  await prisma.townToGdl.upsert({ where: { id: 53 }, update:{}, create:{ townName: "El Limón", price: 504 } })
  await prisma.townToGdl.upsert({ where: { id: 54 }, update:{}, create:{ townName: "Magdalena", price: 168 } })
  await prisma.townToGdl.upsert({ where: { id: 55 }, update:{}, create:{ townName: "Santa María del Oro", price: 412 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 59 }, update:{}, create:{ townName: "Mexticacán", price: 350 } })
  await prisma.townToGdl.upsert({ where: { id: 60 }, update:{}, create:{ townName: "Mezquitic", price: 736 } })
  await prisma.townToGdl.upsert({ where: { id: 61 }, update:{}, create:{ townName: "Mixtlán", price: 310 } })
  await prisma.townToGdl.upsert({ where: { id: 62 }, update:{}, create:{ townName: "Ocotlán", price: 200 } })
  await prisma.townToGdl.upsert({ where: { id: 63 }, update:{}, create:{ townName: "Ojuelos de Jalisco", price: 600 } })
  await prisma.townToGdl.upsert({ where: { id: 64 }, update:{}, create:{ townName: "Pihuamo", price: 432 } })
  await prisma.townToGdl.upsert({ where: { id: 65 }, update:{}, create:{ townName: "Poncitlán", price: 154 } })
  await prisma.townToGdl.upsert({ where: { id: 66 }, update:{}, create:{ townName: "Puerto Vallarta", price: 683 } })
  await prisma.townToGdl.upsert({ where: { id: 67 }, update:{}, create:{ townName: "Villa Purificación", price: 534 } })
  await prisma.townToGdl.upsert({ where: { id: 68 }, update:{}, create:{ townName: "Quitupan", price: 350 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 71 }, update:{}, create:{ townName: "San Diego de Alejandría", price: 393 } })
  await prisma.townToGdl.upsert({ where: { id: 72 }, update:{}, create:{ townName: "San Juan de los Lagos", price: 335 } })
  await prisma.townToGdl.upsert({ where: { id: 73 }, update:{}, create:{ townName: "San Julián", price: 347 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 77 }, update:{}, create:{ townName: "San Miguel el Alto", price: 290 } })
  await prisma.townToGdl.upsert({ where: { id: 78 }, update:{}, create:{ townName: "Gómez Farías", price: 257 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 84 }, update:{}, create:{ townName: "Tamazula de Gordiano", price: 372 } })
  await prisma.townToGdl.upsert({ where: { id: 85 }, update:{}, create:{ townName: "Tapalpa", price: 280 } })
  await prisma.townToGdl.upsert({ where: { id: 86 }, update:{}, create:{ townName: "Tecalitlán", price: 372 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 90 }, update:{}, create:{ townName: "Teocaltiche", price: 400 } })
  await prisma.townToGdl.upsert({ where: { id: 91 }, update:{}, create:{ townName: "Teocuitatlán de Corona", price: 204 } })
  await prisma.townToGdl.upsert({ where: { id: 92 }, update:{}, create:{ townName: "Tepatitlán de Morelos", price: 179 } })
  await prisma.townToGdl.upsert({ where: { id: 93 }, update:{}, create:{ townName: "Tequila", price: 147 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 98 }, update:{}, create:{ townName: "Tolimán", price: 441 } })
  await prisma.townToGdl.upsert({ where: { id: 99 }, update:{}, create:{ townName: "Tomatlán", price: 913 } })
  await prisma.townToGdl.upsert({ where: { id: 100 }, update:{}, create:{ townName: "Tonalá", price: 46 } })
  await prisma.townToGdl.upsert({ where: { id: 101 }, update:{}, create:{ townName: "Tonaya", price: 450 } })
  await prisma.townToGdl.upsert({ where: { id: 102 }, update:{}, create:{ townName: "Tonila", price: 377 } })
  await prisma.townToGdl.upsert({ where: { id: 103 }, update:{}, create:{ townName: "Totatiche", price: 487 } })
  await prisma.townToGdl.upsert({ where: { id: 104 }, update:{}, create:{ townName: "Tototlán", price: 158 } })
  await prisma.townToGdl.upsert({ where: { id: 105 }, update:{}, create:{ townName: "Tuxcacuesco", price: 450 } })
  await prisma.townToGdl.upsert({ where: { id: 106 }, update:{}, create:{ townName: "Tuxcueca", price: 210 } })
  await prisma.townToGdl.upsert({ where: { id: 107 }, update:{}, create:{ townName: "Tuxpan", price: 347 } })
  await prisma.townToGdl.upsert({ where: { id: 108 }, update:{}, create:{ townName: "Unión de San Antonio", price: 465 } })
  await prisma.townToGdl.upsert({ where: { id: 109 }, update:{}, create:{ townName: "Unión de Tula", price: 354 } })
  await prisma.townToGdl.upsert({ where: { id: 110 }, update:{}, create:{ townName: "Valle de Guadalupe", price: 239 } })
  await prisma.townToGdl.upsert({ where: { id: 111 }, update:{}, create:{ townName: "Valle de Juárez", price: 322 } })
  await prisma.townToGdl.upsert({ where: { id: 112 }, update:{}, create:{ townName: "San Gabriel", price: 345 } })
  ...
  await prisma.townToGdl.upsert({ where: { id: 115 }, update:{}, create:{ townName: "Villa Hidalgo", price: 464 } })
  await prisma.townToGdl.upsert({ where: { id: 116 }, update:{}, create:{ townName: "Cañadas de Obregón", price: 296 } })
  await prisma.townToGdl.upsert({ where: { id: 117 }, update:{}, create:{ townName: "Yahualica de González Gallo", price: 299 } })
