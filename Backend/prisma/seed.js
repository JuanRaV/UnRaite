...
async function main() {
  ...
  await prisma.townToGdl.upsert({ where: { id: 120 }, update:{}, create:{ townName: "Zapotiltic", price: 510 } })
  await prisma.townToGdl.upsert({ where: { id: 121 }, update:{}, create:{ townName: "Zapotitlán de Vadillo", price: 628 } })
  await prisma.townToGdl.upsert({ where: { id: 122 }, update:{}, create:{ townName: "Zapotlán del Rey", price: 277 } })
  await prisma.townToGdl.upsert({ where: { id: 123 }, update:{}, create:{ townName: "Zapotlanejo", price: 155 } })
  await prisma.townToGdl.upsert({ where: { id: 124 }, update:{}, create:{ townName: "San Ignacio Cerro Gordo", price: 490 } })
